...
------------ | ------------- | ------------- | -------------
**id** | **str** | 顧客 ID。100桁までの一意な文字列を指定できます。使える文字は半角英数字、ハイフン(-)、アンダースコア(_)です。未指定時は &#x60;cus_&#x60; で始まる一意な文字列が自動生成されます。 | [optional] 
**payment_method_id** | **str** | 顧客に紐づける支払い方法 ID。同時にデフォルトの支払い方法として登録されます。 | [optional] 
