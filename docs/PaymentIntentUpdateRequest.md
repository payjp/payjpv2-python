...
json = "{}"
# create an instance of PaymentIntentUpdateRequest from a JSON string
payment_intent_update_request_instance = PaymentIntentUpdateRequest.from_json(json)
# print the JSON string representation of the object
print(PaymentIntentUpdateRequest.to_json())

# convert the object into a dict
payment_intent_update_request_dict = payment_intent_update_request_instance.to_dict()
# create an instance of PaymentIntentUpdateRequest from a dict
payment_intent_update_request_from_dict = PaymentIntentUpdateRequest.from_dict(payment_intent_update_request_dict)
```
