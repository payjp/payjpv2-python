...
class PaymentMethodsApi:
    ...
    def update_payment_method(
        self,
        payment_method_id: StrictStr,
        payment_method_card_update_request: PaymentMethodCardUpdateRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param payment_method_id: (required)
        :type payment_method_id: str
        :param payment_method_card_update_request: (required)
        :type payment_method_card_update_request: PaymentMethodCardUpdateRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._update_payment_method_serialize(
            payment_method_id=payment_method_id,
            payment_method_card_update_request=payment_method_card_update_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def _update_payment_method_serialize(
        self,
        payment_method_id,
        payment_method_card_update_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if payment_method_card_update_request is not None:
            _body_params = payment_method_card_update_request
