...
class PaymentIntentListResponse(BaseModel):
    ...
    data: List[PaymentIntentResponse] = Field(description="支払いインテントリスト")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [PaymentIntentResponse.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
