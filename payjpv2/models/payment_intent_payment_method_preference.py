...
class PaymentIntentPaymentMethodPreference(BaseModel):
    """
    PaymentIntentPaymentMethodPreference
    """ # noqa: E501
    payment_intent: PaymentIntentResponse
    __properties: ClassVar[List[str]] = ["payment_intent"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "payment_intent": PaymentIntentResponse.from_dict(obj["payment_intent"]) if obj.get("payment_intent") is not None else None
        })
        return _obj
