...
class PaymentIntentUpdateRequest(BaseModel):
    ...
    amount: Optional[StrictInt] = Field(default=None, description="支払い予定の金額。50円以上9,999,999円以下である必要があります。支払い手段によって上限金額は異なります。")
    ...
    __properties: ClassVar[List[str]] = ["payment_method", "payment_method_data", "payment_method_options", "payment_method_types", "receipt_email", "return_url", "description", "amount", "customer", "metadata"]
