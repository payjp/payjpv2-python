...
class PaymentMethodBankTransferCreateRequest(BaseModel):
    """
    ...
    type: StrictStr
    amount: StrictInt = Field(description="振込金額")
    __properties: ClassVar[List[str]] = ["billing_details", "type", "amount"]
