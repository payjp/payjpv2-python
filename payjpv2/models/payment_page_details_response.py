...
class PaymentPageDetailsResponse(BaseModel):
    """
    PaymentPageDetailsResponse
    """ # noqa: E501
    id: StrictStr
    object: Optional[StrictStr] = 'checkout.session'
    checkout_session: CheckoutSessionDetailsResponse
    __properties: ClassVar[List[str]] = ["id", "object", "checkout_session"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.checkout_session:
            _dict['checkout_session'] = self.checkout_session.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "checkout_session": CheckoutSessionDetailsResponse.from_dict(obj["checkout_session"]) if obj.get("checkout_session") is not None else None
        })
        return _obj
