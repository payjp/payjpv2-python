...
class SetupIntentCancelRequest(BaseModel):
    """
    SetupIntentCancelRequest
    """ # noqa: E501
    cancellation_reason: Optional[StrictStr] = Field(default=None, description="この SetupIntent のキャンセル理由。  | 指定できる値 | |:---| | **abandoned**: 顧客が支払いを完了しなかった場合。 | | **requested_by_customer**: 顧客がキャンセルを要求した場合。 | | **duplicate**: 支払い方法が重複している場合。 |")
