...
class SetupIntentPaymentMethodPreference(BaseModel):
    """
    SetupIntentPaymentMethodPreference
    """ # noqa: E501
    setup_intent: SetupIntentResponse
    __properties: ClassVar[List[str]] = ["setup_intent"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "setup_intent": SetupIntentResponse.from_dict(obj["setup_intent"]) if obj.get("setup_intent") is not None else None
        })
        return _obj
