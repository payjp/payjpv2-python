...
class TestValidationErrors:
    ...
    def test_negative_amount_validation(self):
        """Test validation of negative amounts (if implemented)."""
        # Test that negative amounts can be set (validation happens server-side)
    ...
    def test_invalid_currency_validation(self):
        ...
        # PaymentIntentCreateRequest doesn't have currency field in this implementation
